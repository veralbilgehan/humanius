...
const BELGE_KATEGORILER = [
  { id: 'ise_giris_bildirgesi', label: 'İ�x Yeri Giri�x Bildirgesi', aciklama: 'SGK i�xe giri�x bildirge belgesi' },
  { id: 'adli_sicil', label: 'Adli Sicil Kaydı', aciklama: 'Cumhuriyet Savcılı�xından alınan adli sicil belgesi' },
  { id: 'adres_belgesi', label: 'Adres Belgesi', aciklama: 'e-Devlet üzerinden alınan yerle�xim yeri belgesi' },
  { id: 'gorev_tanimi_belgesi', label: 'Görev Tanımı Dosyası', aciklama: 'Onaylı görev tanımı belgesi' },
  { id: 'diger', label: 'Di�xer Belgeler', aciklama: 'Di�xer resmi belgeler' },
] as const;
...
const TABS: { id: TabId; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { id: 'bordro', label: 'Bordro �zeti', icon: Briefcase },
  ...
  { id: 'sikayetler', label: '�~ikayetler', icon: AlertTriangle },
];
...
const izinTuruLabel = (tur: string) => {
  const map: Record<string, string> = {
    ...
    dogum: 'Do�xum', babalik: 'Babalık', evlilik: 'Evlilik', olum: '�lüm',
    ucretsiz: '�Scretsiz',
  };
  return map[tur] ?? tur;
};
            ...
            <button
              onClick={() => {
                if (selectedEmp?.approval_passcode) {
                  ...
                  // �~ifre tanımlı de�xil, direkt yedekle
                  performBackup();
                }
              }}
          ...
          {!isAccessGranted ? (
            <div className="bg-white rounded-2xl border border-rose-200 overflow-hidden p-12 flex flex-col items-center justify-center text-center shadow-sm">
              ...
              <p className="text-slate-500 max-w-lg leading-relaxed">
                ...
                butonuna tıklayıp �xifreyi girin veya QR kodu okutun.
              </p>
            </div>
          ) : (
            ...
            <div className="p-5">
                      ...
                      <table className="w-full text-sm">
                        <thead className="bg-gray-50 border-b border-gray-200">
                          <tr>
                            ...
                            <th className="px-4 py-2.5 text-right text-xs font-semibold text-gray-500">Brüt �Scret</th>
                            <th className="px-4 py-2.5 text-right text-xs font-semibold text-gray-500">Net �Scret</th>
              ...
              {activeTab === 'sikayetler' && (
                <TutanakSikayetPanel
                  kategori="sikayet"
                  baslik="�~ikayetler"
                  aciklama="�!alı�xana yapılan �xikayet bildirimleri ve ilgili belgeler"
