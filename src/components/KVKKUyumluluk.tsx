...
const KVKKUyumluluk: React.FC<KVKKUyumlulukProps> = ({ employees = [] }) => {
  ...
  const handleDownloadReport = () => {
    ...
    const kontroller = [
      { kontrol: 'Kisisel Veri Envanteri hazirlandi', durum: true, oncelik: 'Yuksek' },
      { kontrol: 'Acik riza metinleri guncel', durum: true, oncelik: 'Yuksek' },
      { kontrol: 'Veri isleme amaclari tanimlandi', durum: true, oncelik: 'Yuksek' },
      { kontrol: 'KVKK Kurulu kaydi yapildi', durum: true, oncelik: 'Yuksek' },
      { kontrol: 'Veri guvenligi politikasi yayinlandi', durum: true, oncelik: 'Orta' },
      { kontrol: 'Personel KVKK egitimi tamamlandi', durum: true, oncelik: 'Orta' },
      { kontrol: 'Veri ihlal bildirim proseduru hazir', durum: true, oncelik: 'Yuksek' },
      { kontrol: 'Ucuncu taraf veri isleyici sozlesmeleri', durum: false, oncelik: 'Yuksek' },
      { kontrol: 'Veri silme/imha proseduru aktif', durum: true, oncelik: 'Orta' },
      { kontrol: 'DPO (Veri Sorumlusu Temsilcisi) atandi', durum: false, oncelik: 'Yuksek' },
      { kontrol: 'Uluslararasi veri aktarim sozlesmeleri', durum: true, oncelik: 'Dusuk' },
      { kontrol: 'Cerez politikasi guncel', durum: true, oncelik: 'Dusuk' },
    ];
